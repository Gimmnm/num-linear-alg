...
A = np.array([
    ...
    [1, 5.4202, 2.5, 9.8, 3.42, 2, 10, 5, 42, 2, 1, 1],
...
# 给定向量 b
b = np.array([25.9, 29.5, 27.9, 25.9, 29.9, 29.9, 30.9, 28.9, 84.9, 82.9, 35.9, 31.5, 31.0, 30.9, 30.0, 28.9, 36.9, 41.9, 40.5, 43.9, 37.5, 37.9, 44.5, 37.9, 38.9, 36.9, 45.8, 41.0])
